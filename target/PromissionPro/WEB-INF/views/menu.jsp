...
<div id="menu_toolbar">
    <div>
        ...
        <a class="easyui-linkbutton" iconCls="icon-remove" plain="true" id="delect">刪除</a>
...
<div id="menu_dialog_bt">
    <a class="easyui-linkbutton" iconCls="icon-save" plain="true" data-cmd="save" id="save">保存</a>
    <a class="easyui-linkbutton" iconCls="icon-cancel" plain="true" data-cmd="cancel" id="cancel">取消</a>
</div>
</body>
</html>
